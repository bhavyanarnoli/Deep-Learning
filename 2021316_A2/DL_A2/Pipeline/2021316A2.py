...
"""
# Image Downloader (CIFAR-10)
image_dataset_downloader = torchvision.datasets.CIFAR10(
    root='./data',
    train=True,  # Set to False for the test set
    download=True,  # Downloads the dataset if not present
    transform=torchvision.transforms.ToTensor()  # You can add other transformations as needed
)

# Audio Downloader (SpeechCommand V0.02)
